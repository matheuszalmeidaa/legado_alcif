...
--
-- Observações:
--   - dfs.lais.legado_filtro não tem coluna de parcelas
--     (qtd_parcelas ou equivalente), então prazo sai NULL no lado
--     histórico. Também não dá pra aplicar o filtro de prazo
--     (84/96/108) nesse lado por falta dessa informação.
--   - dat_crc é DATE em dfs.lais.legado_filtro e TEXT em
--     csd.workbank.proposta, no formato 'DD/MM/YYYY HH:MM:SS'
--     (ex.: '30/06/2026 00:00:00'), por isso o parse com TO_DATE
--     e máscara explícita no lado de proposta.
-- ============================================================
